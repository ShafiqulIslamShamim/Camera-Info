    ...
    public static String getAllCameraInfo(CameraManager cm) {
        ...
        try {
            ...
            Map<String, CameraLensClassifier.LensResult> lensMap =
                    ...
                    sb.append("CameraManager IDs List = ").append(BuildPropHelper.objectToString(cm.getCameraIdList()))
                    .append("\n")
                    .append("\n============================\n");
            ...
            for (String id : validCameraIds) {
                ...
                try {
                    ...
                    if (facing != null) {
                        facingStr = (facing == CameraCharacteristics.LENS_FACING_BACK ? "BACK" :
                ...
                try {
                    ...
                    if (focalLengths != null && focalLengths.length > 0 && sensorSize != null) {
                        ...
                        sb.append("35mm eqv FocalLength = ").append(String.format("%.2fmm", focalEq)).append("\n");
                    } else {

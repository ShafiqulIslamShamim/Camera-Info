...
public class CameraCharacteristicsFormatter {
  ...
  /**
   * Translates a complete collection of camera characteristics into an informative, user-friendly
   * log.
   *
   * @param c The CameraCharacteristics object representing the hardware lens.
   * @return Formatted multiline string containing characteristics key-value details.
   */
  ...
  /**
   * Comprehensive value formatter translating specific system key values to formatted strings or
   * code-label maps.
   *
   * @param name Key name.
   * @param value Real object value.
   * @return Formatted key info.
   */
  ...
  /**
   * Helper that translates a single integer code value into its human-readable equivalent according
   * to a mapping.
   *
   * @param v Int code.
   * @param map Target dictionary containing descriptions.
   * @return Formatted string including numerical representation.
   */
  ...
  /**
   * Helper that translates an array of integer codes to a bracket-wrapped string of formatted
   * descriptions.
   *
   * @param vals Array of numerical values.
   * @param map Description dictionary.
   * @return Formatted list of descriptions.
   */
  ...
  /**
   * Standardizes reflection-based parsing of arbitrary arrays into bracket-wrapped comma-separated
   * listings.
   *
   * @param arr The array object.
   * @return Formatted string listing elements.
   */
  ...
  /**
   * Formats a float array using localized decimal formats.
   *
   * @param arr Target float array.
   * @return Formatted float elements.
   */
  ...
  /**
   * Formats a long array into bracket-wrapped elements.
   *
   * @param arr Target long array.
   * @return Formatted long elements.
   */
  ...
  /**
   * Formats an array of Rect objects.
   *
   * @param arr Target Rect array.
   * @return Formatted Rect elements.
   */
  ...
  /**
   * Combines generic array elements with a descriptive descriptor block.
   *
   * @param arr Target array object.
   * @param desc Associated descriptor label.
  ...
  /**
   * Reflectively invokes getDescriptions on modern mandatory stream combinations to expose
   * supported streams.
   *
   * @param value MandatoryStreamCombination structure.
   * @return Formatted descriptions of available stream topologies.
   */

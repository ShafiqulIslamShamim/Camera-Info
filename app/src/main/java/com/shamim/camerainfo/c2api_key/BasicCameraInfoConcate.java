...
public final class BasicCameraInfoConcate {
  ...
  /**
   * Concatenates description logs of all primary camera settings.
   *
   * @param ch CameraCharacteristics representing target lens.
   * @return Multi-line descriptive string.
   */
  ...
  /**
   * Describes key capture features (like RAW, burst support) and appends check/cross markers.
   *
   * @param ch CameraCharacteristics representing target lens.
   * @return Formatted capabilities check log.
   */
  ...
  /**
   * Describes the available auto exposure modes.
   *
   * @param ch CameraCharacteristics representing target lens.
   * @return Formatted AE modes check log.
   */
  ...
  /** Translates AE mode int constants into descriptions. */
  ...
  /** Queries if AE lock support is active. */
  ...
  /** Resolves the AE compensation range. */
  ...
  /** Resolves the AE compensation steps. */
  ...
  /** Describes available target FPS ranges. */
  ...
  /** Translates AF mode constants into descriptions. */
  ...
  /** Describes auto white balance modes. */
  ...
  /** Translates AWB mode constants into descriptions. */
  ...
  /** Queries if AWB lock is supported. */
  ...
  /** Describes request capabilities. */
  ...
  /** Translates capability constants into descriptions. */
  ...
  // -------- Video Stabilization --------
  /** Describes digital video stabilization modes. */
  ...
  /** Translates video stabilization mode constants into descriptions. */
  ...
  // -------- Lens OIS --------
  /** Describes lens optical stabilization modes. */
  ...
  /** Translates OIS mode constants into descriptions. */
  ...
  // -------- Helpers --------
  /** Converts an array of primitive ints to a boxed integer list. */
  ...
  /** Joins elements of a list into a single comma-separated string. */

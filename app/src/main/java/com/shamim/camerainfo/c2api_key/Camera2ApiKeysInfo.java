...
public class Camera2ApiKeysInfo {
  ...
  /**
   * Constructs Camera2ApiKeysInfo initialized with the system camera manager.
   *
   * @param cameraManager System CameraManager service.
   */
  public Camera2ApiKeysInfo(CameraManager cameraManager) {
    this.mCameraManager = cameraManager;
  }

  /** Formats description details representing camera lens facing. */
  ...
  /** Formats the supported hardware compliance level description. */
  ...
  /** Translates capability constant IDs to readable format labels. */
  ...
  /** Formats device output support specifications. */
  ...
  /** Safe check evaluating presence of Allocation support dynamically. */
  ...
  /** Formats the collection of all request capabilities into a structured log. */
  ...
  /** Lists available capture request keys. */
  ...
  /** Lists available capture result keys. */
  ...
  /** Translates and prints raw characteristics details. */
  ...
  /** Formats standard formats output list map definitions. */
  ...
  /** Formats output listings of surface/texture classes. */
  ...
  /** Formats high speed video output lists. */
  ...
  /** Translates format integers to descriptive label strings. */
  public static String getFormatName(int i) {
    return getValueFromMap(sImageFormats, Integer.valueOf(i));
  }

  /** Safely resolves key labels from sparse arrays or falls back to raw string codes. */
  ...
  /**
   * Builds custom, detailed camera descriptions including computed field properties.
   *
   * @param c Device camera characteristics structures.
   * @return Formatted extra camera specs log.
   */
  ...
  /** Translates compliant level constants to descriptive compliance labels. */
  ...
  /** Discovers physical lenses bundled within a logical camera. */
  ...
  /** Concatenates two generic arrays. */
  ...
  /** Calculates actual physical sensor pixel size. */
  ...
  /** Resolves diagonal angle of view in degrees. */
  ...
  /** Resolves 35mm equivalent focal length in mm. */
  public static float calculate35mmeqv(float focalLength, SizeF sensorSize) {
    return (36.0f / sensorSize.getWidth()) * focalLength;
  }

  /** Resolves safe output sizes, preventing empty collections or crash failures. */
  ...
  /** Inspects and maps raw capture support availability markers. */
  ...
  /** Aggregates diverse metadata descriptions into unified log details. */
  ...
  /** Concatenates valid non-null output sizes of modern formats. */
  ...
  /** Translates output format numbers to their formal name labels. */

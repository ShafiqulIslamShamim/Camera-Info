...
public class CameraResolationFormatter {
  ...
  /**
   * Formats the list of supported camera output sizes for a given numerical ImageFormat or
   * PixelFormat.
   *
   * @param streamConfigurationMap The StreamConfigurationMap containing camera configurations.
  ...
  /**
   * Formats the list of supported camera output sizes for a given surface/holder class type.
   *
   * @param streamConfigurationMap The StreamConfigurationMap containing camera configurations.
   * @param cls Class type (like SurfaceTexture.class).
   * @return Formatted string representation.
   */
  ...
  /**
   * Formats high speed video recording sizes along with their supported target frame rate ranges.
   *
   * @param streamConfigurationMap The StreamConfigurationMap containing camera configurations.
   * @return Formatted high speed video recording sizes.
   */
  ...
  /**
   * Inspects and logs comprehensive output formats and supported resolutions for raw, private, or
   * surface targets.
   *
   * @param cameraCharacteristics Hardware details of the device.
   * @return Formatted output size configurations.
   */
  ...
  /** Translates format code to its symbolic constant representation. */
  ...
  /** Resolves a user-friendly description of the ImageFormat / PixelFormat. */
  private static String getFormatDescription(int format) {
    return FORMAT_DESCRIPTION_MAP.getOrDefault(format, "Unknown format");
  }

  /** Maps frame-rate ranges into a cohesive readable string. */
  ...
  /** Appends two arrays of Size objects into a single cohesive array. */

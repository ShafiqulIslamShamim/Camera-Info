...
public class CaptureResultFormatter {
  ...
  /**
   * Generates a detailed string of available capture result keys.
   *
   * @param cameraCharacteristics The Characteristics object for the camera device.
   * @return A formatted string listing each available result key with its description and values.
   */
  ...
  /**
   * Helper that formats a single capture result key with description and permissible values.
   *
   * @param name Name of the capture result key.
  ...
  /**
   * Resolves the user-friendly description of standard capture result keys.
   *
   * @param name The capture result key name.
  ...
  private static String getDescription(String name) {
    switch (name) {
      ...
      case "android.control.enableZsl":
        return "Indicates whether Zero Shutter Lag (ZSL) mode was active for the capture";
      case "android.jpeg.gpsLocation":
        return "Provides GPS location metadata embedded in the captured JPEG image";
      case "android.lens.distortion":
        return "Specifies the lens distortion parameters used to correct optical aberrations";
      case "android.lens.intrinsicCalibration":
      ...
      case "android.scaler.cropRegion":
        return "Reports the active pixel region of the sensor used during image scaling and output";
      case "android.sensor.dynamicWhiteLevel":
        return "Specifies the dynamic white level of the sensor for the given exposure settings";
      case "android.tonemap.curve":
        return "Returns the actual tonemap curve applied during image processing";
  ...
  /**
   * Identifies and aggregates available options/values associated with a result key.
   *
   * @param name Key name to analyze.
   * @return String displaying formatted available values.
   */
  ...
  /**
   * Converts option integer-to-string mappings into a cohesive string.
   *
   * @param map Code-to-description mapping.
   * @return Formatted aggregate values string.
   */

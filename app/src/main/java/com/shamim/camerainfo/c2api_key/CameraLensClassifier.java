...
public class CameraLensClassifier {
  ...
  public enum LensType {
    ...
    /** Converts the lens type to a human-readable string representation. */
    @Override
  ...
  public static class LensResult {
    ...
    /**
     * Constructs a LensResult mapping a lens type to its evaluated zoom factor.
     *
     * @param type The identified LensType.
     * @param zoomFactor Calculated zoom scaling factor.
     */
  ...
  /**
   * Main entry point to detect lenses and return a map of cameraId to LensResult.
   *
   * @param validCameraIds List of camera IDs validated on the device.
   * @return A map mapping camera IDs to LensResult details.
   */
   ...
   */
  /**
   * Evaluates if a camera is logical via the physical camera ids system API.
   *
   * @param cameraId The camera ID to test.
   * @return true if the API confirms physical camera support behind a logical ID, false otherwise.
   */
  ...
  /**
   * Performs a bitwise check on the parsed camera ID to detect hidden virtual camera
   * configurations.
   *
   * @param cameraId The camera ID.
   * @return true if the bit-6 flag is set, false otherwise.
   */
   ...
   */
  /**
   * Performs equivalence testing on primary CameraCharacteristics to evaluate matching sensors.
   *
   * @param a The first characteristics object.
   * @param b The second characteristics object.
   * @return true if equivalent properties are found, false otherwise.
   */
  ...
  /**
   * Helper that compares two float arrays for structural and value equality (within margin).
   *
  ...
  /**
   * Helper that compares two int arrays for absolute equality.
   *
  ...
  /**
   * Helper that compares two SizeF physical objects for equivalence (within margin).
   *
   * @param a First SizeF object.
   * @param b Second SizeF object.
   * @return true if equal, false otherwise.
   */
  ...
  /**
   * Internal classification logic executing specific filters to distinguish Ultrawide, Telephoto,
   * Depth, and Logical sensors. Preserves structural layout matching standard camera
   * specifications.
   *
   * @param group List of LensInfo structures to classify.
   * @param label String label denoting front/back lens facing.
   */

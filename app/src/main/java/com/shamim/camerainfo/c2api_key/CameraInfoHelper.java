...
public class CameraInfoHelper {
  ...
  /**
   * Scans for valid camera IDs (up to 512 indices) and populates the valid IDs collection.
   *
  ...
  /**
   * Gathers and structures comprehensive camera specs into a unified report string based on current
   * pref settings.
   *
   * @param cm System CameraManager.
   * @return Formatted multi-line camera specifications report.
   */

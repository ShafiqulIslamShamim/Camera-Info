...
public class DeviceInfo {
    ...
    public static String getResolutionString() {
        Display defaultDisplay = ((WindowManager) getAppContext().getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay();
    ...
    public static String getTotalRAM() {
        ...
        try {
            ...
            return d4 > 1 ? decimalFormat.format(d4).concat(" TB")
                 : d3 > 1 ? decimalFormat.format(d3).concat(" GB")
                 : d2 > 1 ? decimalFormat.format(d2).concat(" MB")

...
public class OTAUpdateHelper {
  ...
  private static class UpdateCheckExecutor {
    ...
    public void run() {
      ...
      if (!autoCheck) {
        ...
        */
        ...
        textView.setText("Please wait, checking for updates...");
        ...
        set.connect(
            textView.getId(), ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP);
        set.connect(
            textView.getId(), ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM);
        set.connect(
            textView.getId(), ConstraintSet.END, ConstraintSet.PARENT_ID, ConstraintSet.END);
    ...
    private void fetchUpdate(AlertDialog progressDialog) {
      try {
        String encodedUrl =
            "aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL1NoYWZpcXVsSXNsYW1TaGFtaW0vQ2FtZXJhLUluZm8vbWFpbi9VcGRhdGVDaGVja2VySW5mby50eHQ=";
        String textUrl =

...
public class Camera2ApiKeysInfo {
    ...
    public static String formatCameraFacing(CameraCharacteristics cameraCharacteristics) {
        return "Facing: " + getValueFromMap(sLensFacing, (Integer) cameraCharacteristics.get(CameraCharacteristics.LENS_FACING));
    }

    public static String formatHwLevel(CameraCharacteristics cameraCharacteristics) {
        return "SupportedHardwareLevel = " + getValueFromMap(sHardwareLevelMap, (Integer) cameraCharacteristics.get(CameraCharacteristics.INFO_SUPPORTED_HARDWARE_LEVEL));
    }
    ...
    public static String formatOutputSizes(CameraCharacteristics cameraCharacteristics) {
        ...
        if (streamConfigurationMap != null) {
            ...
            boolean isOutputSupportedFor5 = StreamConfigurationMap.isOutputSupportedFor(MediaRecorder.class);
    ...
    public static String formatResultKeys(CameraCharacteristics cameraCharacteristics) {
        if (cameraCharacteristics != null) {
            ...
            Iterator<CaptureResult.Key<?>> it = cameraCharacteristics.getAvailableCaptureResultKeys().iterator();
            while (it.hasNext()) {
                sb.append(String.format(Locale.US, "%s\n", it.next().getName()));
            }
            return sb.toString();
    ...
    public static String formatSizes(StreamConfigurationMap streamConfigurationMap, int i) {
        ...
        Size[] m = Build.VERSION.SDK_INT >= 23 ? streamConfigurationMap.getHighResolutionOutputSizes(i) : null;
        if (m != null && m.length != 0) {
            outputSizes = (Size[]) concatenate(outputSizes, m);
        }
        StringBuilder sb = new StringBuilder(String.format(Locale.US, "%s sizes: \n[", getFormatName(i)));
        for (int i2 = 0; i2 < outputSizes.length; i2++) {
            ...
            if (outputMinFrameDuration == 0 && outputStallDuration == 0) {
                ...
                sb.append(String.format(Locale.US, "%s@(%.3f, %.1f)", size, Float.valueOf(f), Float.valueOf(f2)));
            }
    ...
    public static String formatHighSpeedSizes(StreamConfigurationMap streamConfigurationMap) {
        ...
        for (int i = 0; i < highSpeedVideoSizes.length; i++) {
            ...
            sb.append(String.format(Locale.US, "%s @(%s)", size, Arrays.toString(streamConfigurationMap.getHighSpeedVideoFpsRangesFor(size))));
    ...
    public static String getValueFromMap(SparseArray<String> sparseArray, Integer num) {
      ...
      public static String buildExtraDetails(CameraCharacteristics c) {
        ...
        try {
            ...
            if (sensorSize != null) {
                sb.append("SensorSize = ").append(String.format("%.3fx%.3f",
                        sensorSize.getWidth(), sensorSize.getHeight())).append("\n");
            }
        } catch (Exception ignored) {}
        ...
        try {
            ...
            if (pixelArray != null) {
                sb.append("PixelArray = ").append(pixelArray.getWidth())
                        .append("x").append(pixelArray.getHeight()).append("\n");
        ...
        try {
            ...
            if (focalLengths != null && focalLengths.length > 0 && sensorSize != null && pixelArraytwo != null) {
        ...
        try {
            ...
            if (c.get(CameraCharacteristics.SCALER_STREAM_CONFIGURATION_MAP) != null) {
                rawSizes = c.get(CameraCharacteristics.SCALER_STREAM_CONFIGURATION_MAP)
    ...
    public static boolean isLogicalCameraId(CameraCharacteristics currentCameraCharacteristics) {
        return (currentCameraCharacteristics == null || currentCameraCharacteristics.getPhysicalCameraIds().isEmpty()) ? false : true;
    }
    ...
    public static Size[] PreventEmptyOutputSize(StreamConfigurationMap streamConfigurationMap, int i) {
    ...
    public static String getMoreInfos(CameraCharacteristics cameraCharacteristics) {
        ...
        try {
            ...
            if (sensitivityRange != null) {
                sb.append("SensitivityRange = ")
                        .append(sensitivityRange.getLower()).append(" - ")
        ...
        try {
            ...
            if (aeRange != null) {
                sb.append("\nAeCompensationRange = ")
                        .append(aeRange.getLower()).append(" - ")
        ...
        try {
            ...
            if (caps != null) {
                sb.append("\nAvailableCapabilities = ")
                        .append(BuildPropHelper.objectToString(caps));
            }
        } catch (Throwable e) {

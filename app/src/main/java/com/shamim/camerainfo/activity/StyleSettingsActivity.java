  ...
  private void updateUI() {
    ...
    if (ivStylePreview != null) {
      try {
        ...
        String svg = "<svg width=\"100%\" height=\"100%\" viewBox=\"0 0 888 678\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
        ...
        svg = svg.replaceAll("t90", t90)
                 ...
                 .replaceAll("t40", t40)
                 .replaceAll("s30", s30);
        ivStylePreview.setColorFilter(null); // Clear previous color filters to let natural colors render

...
public class StyleSettingsActivity extends BaseActivity {
  ...
  /**
   * Initializes style selections layout components and setups theme listeners.
   *
  ...
  /** Configures click listeners for individual accent colors. */
  ...
  /** Updates accent preferences values and restarts views. */
  private void setAccentPreference(String value) {
    SharedPrefValues.putValue("app_theme_preference", value);
    recreateActivity();
  }

  /** Configures click listeners for segmented theme mode selection buttons. */
  ...
  /** Configures check listener and card click listeners for AMOLED modes. */
  private void setupAmoledSelector() {
    ...
    cardAmoledBlack.setOnClickListener(
        v -> {
  ...
  /** Recreates activities securely on UI threads. */
  ...
  /**
   * Evaluates preferences and sets up SVG visual style preview vectors, backgrounds and buttons.
   */
  private void updateUI() {
      ...
      try {
        ...
        String svg =
            "<svg width=\"100%\" height=\"100%\" viewBox=\"0 0 888 678\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n"
                ...
                + "<path id=\"sco50\" d=\"M306.32 656.02L323.502 661.166L323.503 661.166C326.407 662.036 328.846 664.024 330.284 666.692C331.722 669.361 332.042 672.491 331.172 675.395L331.065 675.751L302.934 667.325L306.32 656.02Z\" fill=\"s50\"/>\n"
                + "<path d=\"M390.602 666.663L399.153 663.528L391.13 629.055L378.51 633.682L390.602 666.663Z\" fill=\"#FFB8B8\"/>\n"
                + "<path id=\"sco50\" d=\"M387.398 664.671L404.237 658.496L404.238 658.496C407.084 657.453 410.228 657.583 412.978 658.858C415.729 660.132 417.86 662.447 418.904 665.293L419.031 665.642L391.46 675.751L387.398 664.671Z\" fill=\"s50\"/>\n"
                + "<path id=\"sco90\" d=\"M322.321 600.868L307.464 649.897L325.292 655.097L342.378 609.782L322.321 600.868Z\" fill=\"s90\"/>\n"
                + "<path id=\"sco90\" d=\"M369.121 612.011L382.493 658.068L401.064 649.154L387.693 606.068L369.121 612.011Z\" fill=\"s90\"/>\n"
                + "<path id=\"sco40\" d=\"M362.162 620.318C350.27 620.263 338.406 619.169 326.705 617.047L326.407 616.987V605.657L319.617 604.903L324.917 585.975C322.446 556.815 325.957 519.885 327.092 509.256C327.352 506.764 327.524 505.365 327.524 505.365L333.482 454.715L343.453 445.512L347.982 448.46L356.384 456.861C366.15 480.895 373.899 503.522 373.948 504.976L406.699 609.929L406.479 610.085C395.106 618.113 377.77 620.318 362.162 620.318Z\" fill=\"s40\"/>\n"
                ...
                + "<path id=\"tco90\" d=\"M382.029 512.433H373.231C372.949 512.434 372.677 512.33 372.468 512.14C372.259 511.95 372.128 511.689 372.101 511.408L370.34 493.359H384.919L383.159 511.408C383.132 511.689 383.001 511.95 382.792 512.14C382.583 512.33 382.311 512.434 382.029 512.433V512.433Z\" fill=\"t90\"/>\n"
                + "<path id=\"tco40\" d=\"M384.896 495.63H370.364C370.063 495.63 369.774 495.51 369.561 495.297C369.348 495.085 369.229 494.796 369.228 494.495V491.77C369.229 491.469 369.348 491.18 369.561 490.968C369.774 490.755 370.063 490.635 370.364 490.635H384.896C385.197 490.635 385.486 490.755 385.699 490.968C385.911 491.18 386.031 491.469 386.031 491.77V494.495C386.031 494.796 385.911 495.085 385.699 495.297C385.486 495.51 385.197 495.63 384.896 495.63V495.63Z\" fill=\"t40\"/>\n"
                ...
                + "<path id=\"sco30\" d=\"M246.032 187.616H246.506L255.027 676.148H237.038L246.032 187.616Z\" fill=\"s30\"/>\n"
                + "<path id=\"sco30\" d=\"M273.438 446.177L244.954 461.173L248.923 468.713L277.407 453.717L273.438 446.177Z\" fill=\"s30\"/>\n"
                + "<path id=\"sco40\" d=\"M509.115 671.578C509.115 671.578 509.737 658.552 522.482 660.066Z\" fill=\"s40\"/>\n"
                + "<path id=\"tco90\" d=\"M505.514 659.182C509.037 659.182 511.893 656.326 511.893 652.803C511.893 649.281 509.037 646.425 505.514 646.425C501.991 646.425 499.135 649.281 499.135 652.803C499.135 656.326 501.991 659.182 505.514 659.182Z\" fill=\"t90\"/>\n"
                + "<path id=\"sco40\" d=\"M506.277 663.544H504.476V676.148H506.277V663.544Z\" fill=\"s40\"/>\n"
                + "<path id=\"sco40\" d=\"M67.0829 669.778C67.0829 669.778 67.7046 656.751 80.4493 658.266Z\" fill=\"s40\"/>\n"
                + "<path id=\"tco90\" d=\"M63.4818 657.381C67.0046 657.381 69.8605 654.526 69.8605 651.003C69.8605 647.48 67.0046 644.624 63.4818 644.624C59.959 644.624 57.1032 647.48 57.1032 651.003C57.1032 654.526 59.959 657.381 63.4818 657.381Z\" fill=\"t90\"/>\n"
                + "<path id=\"sco40\" d=\"M64.2445 661.744H62.4439V674.348H64.2445V661.744Z\" fill=\"s40\"/>\n"
                + "<path id=\"sco40\" d=\"M171.514 670.678C171.514 670.678 172.136 657.651 184.881 659.165Z\" fill=\"s40\"/>\n"
                + "<path id=\"tco90\" d=\"M167.913 658.282C171.436 658.282 174.292 655.426 174.292 651.903C174.292 648.38 171.436 645.524 167.913 645.524C164.39 645.524 161.534 648.38 161.534 651.903C161.534 655.426 164.39 658.282 167.913 658.282Z\" fill=\"t90\"/>\n"
                + "<path id=\"sco40\" d=\"M168.676 662.645H166.875V675.248H168.676V662.645Z\" fill=\"s40\"/>\n"
                ...
                + "<path id=\"sco40\" d=\"M683.655 676.307C683.655 676.307 684.277 663.28 697.022 664.794Z\" fill=\"s40\"/>\n"
                + "<path id=\"sco40\" d=\"M563.919 676.307C563.919 676.307 564.541 663.28 577.286 664.794Z\" fill=\"s40\"/>\n"
                + "<path id=\"sco40\" d=\"M127.289 676.307C127.289 676.307 127.91 663.28 140.655 664.794Z\" fill=\"s40\"/>\n"
                + "<path id=\"sco40\" d=\"M737.671 676.307C737.671 676.307 738.293 663.28 751.038 664.794Z\" fill=\"s40\"/>\n"
                + "<path id=\"sco40\" d=\"M712.464 676.307C712.464 676.307 713.086 663.28 725.83 664.794Z\" fill=\"s40\"/>\n"
                + "<path id=\"sco40\" d=\"M660.465 676.307C660.465 676.307 659.843 663.28 647.099 664.794Z\" fill=\"s40\"/>\n"
                + "<path id=\"sco40\" d=\"M453.403 676.307C453.403 676.307 452.781 663.28 440.037 664.794Z\" fill=\"s40\"/>\n"
                + "<path id=\"sco40\" d=\"M281.452 676.307C281.452 676.307 280.83 663.28 268.085 664.794Z\" fill=\"s40\"/>\n"
                + "<path id=\"sco40\" d=\"M98.6969 676.307C98.6969 676.307 98.0752 663.28 85.3305 664.794Z\" fill=\"s40\"/>\n"
                + "<path id=\"sco40\" d=\"M791.904 676.307C791.904 676.307 791.283 663.28 778.538 664.794Z\" fill=\"s40\"/>\n"
                + "<path id=\"sco40\" d=\"M714.481 677.207C714.481 677.207 713.859 664.181 701.115 665.695Z\" fill=\"s40\"/>\n"
                + "<path id=\"sco40\" d=\"M888 674.604H0V676.604H888V674.604Z\" fill=\"s40\"/>\n"
                + "</g>\n"
                + "<defs>\n"
    ...
    if (cardActiveBadge != null) {
      cardActiveBadge.setCardBackgroundColor(
          ColorStateList.valueOf(getBadgeContainerColor(currentAccent)));
    }
  ...
  /** Resolves raw primary colors for active color scheme options. */
  ...
  /** Resolves raw primary container colors with configured transparent overlays. */
  ...
  /** Map attribute keys into compliant resource IDs. */
  ...
  /** Translates resource attributes to format web Hex string tags. */
  private String getColorHexFromAttr(int attribute) {
    int color = getColorFromAttr(attribute);
    return String.format("#%06X", (0xFFFFFF & color));
  }

  /** Pulls dynamic color data values from theme configurations. */

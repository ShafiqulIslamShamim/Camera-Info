...
public class MainActivity extends BaseActivity {
  ...
  /**
   * Initializes main layout components, sets up OTA updates, registers search inputs, and
   * coordinates list modes.
   *
  ...
  /** Retrieves color value associated with active theme attribute parameters. */
  ...
  /** Shares the gathered specs log data as a system attachment text file. */
  ...
  /** Evaluates camera lists and renders device information with color accents asynchronously. */
  ...
  /** Expands the search field and sets soft input focus. */
  ...
  /** Collapses the search overlay and clears input selections. */
  ...
  /** Triggers a search matching pass without forcing a query recalculation. */
  private void updateSearchHighlights() {
    updateSearchHighlights(false);
  }

  /**
   * Highlights matching search queries within text logs using custom background spans.
   *
   * @param forceRequery True if queries must be evaluated from scratch.
   */
  ...
  /** Smoothly scrolls container to designated text indices. */
  ...
  // === Menu Code (Unchanged) ===
  /** Inflates menu resources and binds interactive search, reset, and settings icons. */
  @Override
  ...
  /** Refreshes OTA check conditions on resume. */
  @Override
  ...
  /** Shuts down background search execution threads safely on destroy. */
  @Override
